...
async def run_test():
    ...
    try:
        ...
        # Click 'Continuar' button on onboarding welcome screen
        elem = frame.locator('xpath=html/body/div[2]/div[2]/div[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input current weight and click 'Continuar' to proceed.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test failed: Changes to user settings (goal weight, start date, theme) did not persist or take immediate effect as required by the test plan.")
